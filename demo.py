...
class MyWidget(QtWidgets.QWidget):
    ...
    def initUi(self):
        ...
        startButton = QtWidgets.QPushButton("启动")
        grid.addWidget(startButton, 2, 0)
        grid.addWidget(self.lcd, 2, 1)

        addButton = QtWidgets.QPushButton("添加顾客")
